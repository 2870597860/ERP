...
Response.write "<div align='center'>请选择需要修改的文件名：</div><br>"
...
<a href="http://202.121.197.111:84/Register/WebContent/Modeling/ChangeInsitu.html?=<%=objFile.Name%>" target="_self"><%=objFile.Name%></a><br>
<%Next%>
</td>
</tr>
</table>
