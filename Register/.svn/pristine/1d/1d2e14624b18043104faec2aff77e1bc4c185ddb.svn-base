...
<a href="SimpleRegister/?FLPath=<%=FLPath%>..">上级目录</a><br>
<%End If%>
<a href="javascript:history.back();">后退</a>
<a href="javascript:location.reload();">刷新</a><br>
<%For Each objSubFolder in objSubFolders%>
<a href="SimpleRegister/?FLPath=<%=FLPath%>&amp;FolderPath=<%=FLRoot&FLPath&objSubFolder.Name%>" onclick="return confirm('您确定要删除该文件夹吗？');">删除</a>|<a href="SimpleRegister/?FLPath=<%=FLPath&objSubFolder.Name%>"><%=objSubFolder.Name%></a><br>
<%Next%>
...
<%Next%>
<input name="" type="submit" onclick="return confirm('您确定要删除选中文件吗？');" value="删除" />
