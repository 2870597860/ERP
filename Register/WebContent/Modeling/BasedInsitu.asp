...
Response.write "<div align='center'>请选择基文档来创建新文档：</div><br>"
...
<a href="http://202.121.197.111:84/Register/WebContent/Modeling/BasedInsitu.html?=<%=objFile.Name%>" target="_self"><%=objFile.Name%></a><br>
<%Next%>
