...
foldername=server.MapPath("/Register/WebContent/Modeling/SimpleRegister")
...
<a href="javascript:history.back();">返回</a>
	<form action="http://202.121.197.111:84/Register/WebContent/Register/RegisterSensor.jsp" method="get">
    	<table align="center" width="50%" border="1">
            ...
            <tr>
				...
				<%i=0
					...
					response.Write("<a href=/Modeling/SimpleRegister/"&thing.name&">"&thing.name&"</a>&nbsp;<br>")
					i=i+1
					Next
				%>
